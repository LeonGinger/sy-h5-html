...
/***/ 263:
/*!******************************************************************************!*\
  !*** D:/xampp/htdocs/Traceability/uview-ui/components/u-upload/u-upload.vue ***!
  \******************************************************************************/
...
/***/ 264:
/*!*************************************************************************************************************************!*\
  !*** D:/xampp/htdocs/Traceability/uview-ui/components/u-upload/u-upload.vue?vue&type=template&id=0d33af60&scoped=true& ***!
  \*************************************************************************************************************************/
...
var components = {
  ...
  uLineProgress: function() {
    return __webpack_require__.e(/*! import() | node-modules/uview-ui/components/u-line-progress/u-line-progress */ "node-modules/uview-ui/components/u-line-progress/u-line-progress").then(__webpack_require__.bind(null, /*! uview-ui/components/u-line-progress/u-line-progress.vue */ 380))
  },
  uMask: function() {
...
/***/ 266:
/*!*******************************************************************************************************!*\
  !*** D:/xampp/htdocs/Traceability/uview-ui/components/u-upload/u-upload.vue?vue&type=script&lang=js& ***!
  \*******************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var _exif = _interopRequireDefault(__webpack_require__(/*! @/common/exif.js */ 246));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};}
/**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 * upload 图片上传
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 */var _default2 =
{
    ...
    fileList: {
      ...
      handler: function handler(val) {var _this2 = this;
        val.map(function (value) {
          ...
          var tmp = _this2.lists.some(function (val) {
            return val.url == value.url;
          });
          // 如果内部没有这个图片(tmp为false)，则添加到内部
          !tmp && _this2.lists.push({ url: value.url, error: false, progress: 100 });
        });
      } },
  ...
  methods: {
    ...
    qx: function qx() {
      this.cklt = false;
      // console.log(this.bigimgHeight)
      // console.log(this.bigimgWidth)
    },
    // 清除列表
    ...
    // 选择图片
    selectFile: function selectFile() {var _this3 = this;
      // alert(this.model)
      if (this.disabled) return;
      // let _that = this;
      var _this$name = this.name,name = _this$name === void 0 ? '' : _this$name,maxCount = this.maxCount,multiple = this.multiple,maxSize = this.maxSize,sizeType = this.sizeType,lists = this.lists,camera = this.camera,compressed = this.compressed,maxDuration = this.maxDuration,sourceType = this.sourceType;
      var chooseFile = null;
      ...
      chooseFile = new Promise(function (resolve, reject) {
        uni.chooseImage({
          ...
          sizeType: sizeType,
          success: function () {var _success = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee(res) {var _that;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
                      // console.log(res)
                      _that = _this3;
                      // _that.choosed = true;
                      _that.resImg = res.tempFilePaths[0]; //这就是要的blod
                      if (!(_that.model != "iPhone")) {_context.next = 5;break;}_context.next = 5;return (
                        _that.detail(_that.resImg));case 5:

                      // console.log(_that.resImg)
      ...
      then(function (res) {
        ...
        var file = null;
        var listOldLength = _this3.lists.length;
        res.tempFiles.map(function (val, index) {
          ...
          if (val.size > maxSize) {
            _this3.$emit('on-oversize', val, _this3.lists, _this3.index);
            _this3.showToast('超出允许的文件大小');
          } else {
            if (maxCount <= lists.length) {
              _this3.$emit('on-exceed', val, _this3.lists, _this3.index);
              _this3.showToast('超出最大允许的文件个数');
              return;
            }
            lists.push({
              url: _this3.resImg,
        ...
        _this3.$emit('on-choose-complete', _this3.lists, _this3.index);
        if (_this3.autoUpload) _this3.uploadFile(listOldLength);
      }).
      catch(function (error) {
        _this3.$emit('on-choose-fail', error);
      });
    },
    // 提示用户消息
    ...
    // 上传图片
    uploadFile: function uploadFile() {var _arguments = arguments,_this4 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2() {var index, beforeResponse, task;return _regenerator.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:index = _arguments.length > 0 && _arguments[0] !== undefined ? _arguments[0] : 0;if (!
                _this4.disabled) {_context2.next = 3;break;}return _context2.abrupt("return");case 3:if (!
                _this4.uploading) {_context2.next = 5;break;}return _context2.abrupt("return");case 5:if (!(

                index >= _this4.lists.length)) {_context2.next = 8;break;}
                _this4.$emit('on-uploaded', _this4.lists, _this4.index);return _context2.abrupt("return");case 8:if (!(



                _this4.lists[index].progress == 100)) {_context2.next = 11;break;}
                if (_this4.autoUpload == false) _this4.uploadFile(index + 1);return _context2.abrupt("return");case 11:if (!(



                _this4.beforeUpload && typeof _this4.beforeUpload === 'function')) {_context2.next = 22;break;}
                ...
                beforeResponse = _this4.beforeUpload.bind(_this4.$u.$parent.call(_this4))(index, _this4.lists);
                // 判断是否返回了promise
                if (!(!!beforeResponse && typeof beforeResponse.then === 'function')) {_context2.next = 18;break;}_context2.next = 16;return (
                  beforeResponse.then(function (res) {
                    // promise返回成功，不进行动作，继续上传
                  }).catch(function (err) {
                    // 进入catch回调的话，继续下一张
                    return _this4.uploadFile(index + 1);
                  }));case 16:_context2.next = 22;break;case 18:if (!(
                beforeResponse === false)) {_context2.next = 22;break;}return _context2.abrupt("return",
                ...
                _this4.action) {_context2.next = 25;break;}
                _this4.showToast('请配置上传地址', true);return _context2.abrupt("return");case 25:
                ...
                task = uni.uploadFile({
                  ...
                  success: function success(res) {
                    ...
                    var data = _this4.toJson && _this4.$u.test.jsonString(res.data) ? JSON.parse(res.data) : res.data;
                ...
                task.onProgressUpdate(function (res) {
                  if (res.progress > 0) {
                    _this4.lists[index].progress = res.progress;
                    _this4.$emit('on-progress', res, index, _this4.lists, _this4.index);
                  }
                });case 29:case "end":return _context2.stop();}}}, _callee2);}))();
    },
    // 上传失败
    ...
    deleteItem: function deleteItem(index) {var _this5 = this;
      uni.showModal({
        ...
        content: '您确定要删除此项吗？',
        confirmColor: '#0ABB9A',
        success: function () {var _success2 = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee3(res) {var beforeResponse;return _regenerator.default.wrap(function _callee3$(_context3) {while (1) {switch (_context3.prev = _context3.next) {case 0:if (!
                    res.confirm) {_context3.next = 12;break;}if (!(


                    _this5.beforeRemove && typeof _this5.beforeRemove === 'function')) {_context3.next = 11;break;}
                    // 此处钩子执行 原理同before-remove参数，见上方注释
                    beforeResponse = _this5.beforeRemove.bind(_this5.$u.$parent.call(_this5))(index, _this5.lists);
                    // 判断是否返回了promise
                    if (!(!!beforeResponse && typeof beforeResponse.then === 'function')) {_context3.next = 8;break;}_context3.next = 6;return (
                      beforeResponse.then(function (res) {
                        // promise返回成功，不进行动作，继续上传
                      ...
                      }));case 6:_context3.next = 9;break;case 8:
                    if (beforeResponse === false) {
                      ...
                      // 如果返回true，执行删除操作
                      _this5.handlerDeleteItem(index);
                    }case 9:_context3.next = 12;break;case 11:

                    // 如果不存在before-remove钩子，
                    _this5.handlerDeleteItem(index);case 12:case "end":return _context3.stop();}}}, _callee3);}));function success(_x2) {return _success2.apply(this, arguments);}return success;}() });
    ...
    doPreviewImage: function doPreviewImage(url, index) {var _this6 = this;
      ...
      wx.getImageInfo({
        ...
        success: function success(res) {
          ...
          _this6.cklt = true;
          // console.log(res)
          _this6.bigimgHeight = res.height;
          _this6.bigimgWidth = res.width;
        },
    ...
    //旋转
    detail: function detail(url) {var _this7 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee4() {var maxWidth, Orientation, img, canvas, baseStr;return _regenerator.default.wrap(function _callee4$(_context4) {while (1) {switch (_context4.prev = _context4.next) {case 0:
                maxWidth = 500;
                Orientation = 1;
                //获取图片META信息  
                _context4.next = 4;return _this7.getImageTag(url, 'Orientation', function (e) {
                  if (e != undefined) Orientation = e;
                });case 4:
                img = null;
                canvas = null;_context4.next = 8;return (
                  _this7.comprossImage(url, maxWidth, function (e) {
                    img = e.img;
                    canvas = e.canvas;
                  }));case 8:
                ...
                baseStr = '';
                //如果方向角不为1，都需要进行旋转  
                _context4.t0 = Orientation;_context4.next = _context4.t0 ===
                6 ? 12 : _context4.t0 ===
                ...
                3 ? 16 : 18;break;case 12: //需要顺时针（向右）90度旋转  
                baseStr = _this7.rotateImg(img, 'right', canvas);return _context4.abrupt("break", 20);case 14: //需要逆时针（向左）90度旋转   
                baseStr = _this7.rotateImg(img, 'left', canvas);return _context4.abrupt("break", 20);case 16: //需要180度旋转 转两次  
                baseStr = _this7.rotateImg(img, 'right', canvas, 2);return _context4.abrupt("break", 20);case 18:
                baseStr = _this7.rotateImg(img, '', canvas);return _context4.abrupt("break", 20);case 20:case "end":return _context4.stop();}}}, _callee4);}))();
    ...
    //-------------------------------直接粘贴的三个方法
    comprossImage: function comprossImage(imgSrc, maxWidth, func) {return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee5() {return _regenerator.default.wrap(function _callee5$(_context5) {while (1) {switch (_context5.prev = _context5.next) {case 0:if (
                imgSrc) {_context5.next = 2;break;}return _context5.abrupt("return", 0);case 2:return _context5.abrupt("return",
    ...
    /**  
       	  ...
       	  */
    getImageTag: function getImageTag(file, tag, suc) {
      if (!file) return 0;
      return new Promise(function (resolve, reject) {
        ...
        uni.getImageInfo({
          src: file,
          success: function success(res) {
            _exif.default.getData(imgObj, function () {
              _exif.default.getAllTags(this);
              var or = _exif.default.getTag(this, 'Orientation'); //这个Orientation 就是我们判断需不需要旋转的值了，有1、3、6、8  
              resolve(suc(or));
            });
          } });
    ...
    rotateImg: function rotateImg(img, direction, canvas) {var times = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 1;
      console.log('开始旋转');
      ...
      var base = canvasWidth / canvasHeight;
    ...
    //-----------------------------------------------结束
    uploadImg: function uploadImg(tempFilePaths) {
...
/***/ 268:
/*!****************************************************************************************************************************************!*\
  !*** D:/xampp/htdocs/Traceability/uview-ui/components/u-upload/u-upload.vue?vue&type=style&index=0&id=0d33af60&lang=scss&scoped=true& ***!
  \****************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
